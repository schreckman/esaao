...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # ESAAO window
        self.appearance_mode_label_esaao1 = customtkinter.CTkLabel(self.tabview.tab(_("ESAAO")),
        ...
        self.string_input_button = customtkinter.CTkButton(master=self.tabview.tab(_("ESAAO")),
                                                           text=_("Choose a streamer"),
                                                           command=self.open_input_dialog_event)
        self.string_input_button.grid(row=2, column=0, padx=20, pady=(10, 10))

        # Settings Window
        self.appearance_mode_label_settings1 = customtkinter.CTkLabel(self.tabview.tab(_("Settings")),
                                                                      text=_("Appearance Mode:"),
                                                                      anchor="w")
        self.appearance_mode_label_settings1.grid(row=5, column=0, padx=20, pady=(10, 0))
        self.appearance_mode_optionmenu = customtkinter.CTkOptionMenu(self.tabview.tab(_("Settings")),
    ...
    def open_input_dialog_event(self):
        dialog = customtkinter.CTkInputDialog(text=_("write a streamers name:"), title=_("Streamer name"))
